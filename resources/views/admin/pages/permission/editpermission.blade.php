                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <select name="group_name" class="form-select" id="example-select">
                                            ...
                                            <option value="category"
                                                {{ $data->group_name == 'category' ? 'selected' : '' }}>Category
                                            </option>
                                            <option value="subcategory"
                                                {{ $data->group_name == 'subcategory' ? 'selected' : '' }}>SubCategory
                                            </option>
                                            <option value="news"
                                            ...
                                            <option value="user"
                                                {{ $permission->group_name == 'user' ? 'selected' : '' }}>Review
                                            </option>
                                            <option value="contact"
                                                {{ $permission->group_name == 'contact' ? 'selected' : '' }}>Review
                                            </option>
