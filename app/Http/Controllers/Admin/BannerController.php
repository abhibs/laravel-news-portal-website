...
class BannerController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $old_img4 = $request->old_image4;
        $old_img5 = $request->old_image5;
        $old_img6 = $request->old_image6;

        if ($request->file('home_one')) {
            @unlink('old_img1');
            $image1 = $request->file('home_one');
            $name_gen1 = hexdec(uniqid()) . '.' . $image1->getClientOriginalExtension();
            Image::make($image1)->resize(725, 100)->save('storage/banner/' . $name_gen1);
            $save_url1 = 'storage/banner/' . $name_gen1;
        ...
        if ($request->file('home_two')) {
            ...
            Image::make($image2)->resize(725, 100)->save('storage/banner/' . $name_gen2);
            $save_url2 = 'storage/banner/' . $name_gen2;
        ...
        if ($request->file('home_three')) {
            ...
            Image::make($image3)->resize(725, 100)->save('storage/banner/' . $name_gen3);
            $save_url3 = 'storage/banner/' . $name_gen3;
        ...
        if ($request->file('home_four')) {
            ...
            Image::make($image4)->resize(725, 100)->save('storage/banner/' . $name_gen4);
            $save_url4 = 'storage/banner/' . $name_gen4;
        ...
        if ($request->file('news_category_one')) {
            ...
            Image::make($image5)->resize(725, 100)->save('storage/banner/' . $name_gen5);
            $save_url5 = 'storage/banner/' . $name_gen5;
        ...
        if ($request->file('news_details_one')) {
            ...
            Image::make($image6)->resize(725, 100)->save('storage/banner/' . $name_gen6);
            $save_url6 = 'storage/banner/' . $name_gen6;
